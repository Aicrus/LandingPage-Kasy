...
import { TIKTOK_PIXEL_ID, isTiktokPixelEnabled } from "@/lib/analytics/tiktok";

/** Script base do TikTok Pixel (o page view de cada rota fica no SiteAnalytics). */
export function TiktokPixelScript() {
  if (!isTiktokPixelEnabled()) return null;

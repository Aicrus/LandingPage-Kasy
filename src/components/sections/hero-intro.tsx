...
export function HeroIntro() {
  return (
    <div className="mx-auto flex w-full flex-col items-center gap-hero-title-to-lead text-center">
      <h1 className="max-w-fluid-title text-balance font-heading text-fluid-display text-foreground">
      ...
      <BlurReveal as="div" delay={0.64} className="mt-5 sm:mt-6">
        <Button
          variant="default"
          nativeButton={false}
          className="relative h-auto overflow-hidden rounded-full border-[1.5px] border-[color-mix(in_oklch,var(--primary),white_13%)] px-5 py-2 text-sm shadow-[0_1px_3px_rgba(26,30,44,0.06),0_10px_28px_-8px_rgba(26,30,44,0.16)] transition-shadow duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-primary dark:shadow-[0_1px_3px_rgba(0,0,0,0.26),0_10px_28px_-8px_rgba(0,0,0,0.36)]"
        ...
        >
          ...
          />
          <span className="relative z-10">Obter Kasy</span>
        </Button>
      </BlurReveal>
    </div>
  );

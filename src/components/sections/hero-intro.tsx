    ...
    <div className="mx-auto flex w-full flex-col items-center gap-hero-title-to-lead text-center">
      ...
      <BlurReveal as="div" delay={0.64} className="mt-2 sm:mt-2.5">
        <Button
          variant="default"
          nativeButton={false}
          className="relative h-auto overflow-hidden rounded-full border-[1.5px] border-[color-mix(in_oklch,var(--primary),white_13%)] px-6 py-2.5 font-sans text-[0.9375rem] shadow-[0_1px_3px_rgba(26,30,44,0.06),0_10px_28px_-8px_rgba(26,30,44,0.16)] transition-[transform,box-shadow,filter] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] motion-safe:hover:-translate-y-0.5 motion-safe:hover:shadow-[0_4px_12px_rgba(26,30,44,0.1),0_18px_44px_-12px_rgba(26,30,44,0.24)] motion-safe:hover:brightness-[1.03] motion-safe:active:translate-y-0 motion-safe:active:scale-[0.985] motion-safe:active:shadow-[0_1px_2px_rgba(26,30,44,0.08),0_6px_18px_-6px_rgba(26,30,44,0.14)] hover:bg-primary sm:px-7 sm:py-3 sm:text-base dark:shadow-[0_1px_3px_rgba(0,0,0,0.26),0_10px_28px_-8px_rgba(0,0,0,0.36)] motion-safe:dark:hover:shadow-[0_4px_14px_rgba(0,0,0,0.32),0_20px_48px_-12px_rgba(0,0,0,0.48)]"
